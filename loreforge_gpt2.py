...
# =============================================================================
# Drop-in replacement for loreforge.py using a pretrained GPT-2 base model.
# Skips pretraining entirely — loads GPT-2 from HuggingFace and applies
# per-universe LoRA fine-tuning, RAG, and inference unchanged.
#
...
GPT2_MODEL_NAME = "gpt2"   # options: "gpt2", "gpt2-medium", "gpt2-large", "gpt2-xl"
CONTEXT_LEN     = 512
BATCH_SIZE      = 8
...
class LoRALinear(nn.Module):
    ...
    def __init__(self, layer, rank: int = 8, alpha: float = 16.0):
        ...
        # Conv1D weight shape is (in_features, out_features) — opposite of nn.Linear
        w = layer.weight
